...
public class MultipleCustomerChatMobileTest2 extends BaseMobileTestCase {
    ...
    @Test
    public void testMultipleCustomerChatMobile2() throws Exception {
        HomeMenuBar homeMenuBar = new HomeMenuBar(driver,logger);
        String testWechatAccount = JConfigUtil.getTestAccountAccount2WechatId();
        ...
        SignalCore.sendSignal(packageKey,"shouldAcceptChatRequest2");
    }
